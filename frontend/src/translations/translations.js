export const translations = {
  tr: {
    ...
    citrixSetup: {
      ...
      alertText: 'İnternet bağlantısı zayıf veya kurumsal ağ kısıtlamalıysa "Offline Installer" sürümünü indirin. Bu sürüm tüm bileşenleri tek dosyada içerir (~790 MB).',
      ...
      eulaDecline: 'Hayır',
      tipLabel: 'İpucu',
      footerNote: 'Kurulum tamamlandıktan sonra Citrix Workspace\'i açarak kullanıcı adı ve şifrenizle giriş yapabilirsiniz. Sorun yaşarsanız IT destek ekibine başvurun.',
      step1: {
        title: 'Citrix indirme sayfasına gidin',
        desc: 'Aşağıdaki butona tıklayarak resmi Citrix Workspace indirme sayfasını tarayıcınızda açın.',
        visualTitle: 'Citrix İndirme Sayfası',
        visual1: 'Sayfa açıldığında Windows için mevcut sürümleri göreceksiniz.',
        tip: 'Şirket hesabınız varsa IT departmanından onaylı sürüm bilgisini alın.',
      },
      step2: {
        title: 'Offline Installer dosyasını indirin',
        desc: 'Sayfada "Citrix Workspace app … for Windows — Offline installer" satırını bulun. Önce lisans sözleşmesini kabul edin, ardından İndir butonuna tıklayın.',
        visualTitle: 'Doğru dosyayı seçin',
        tip: 'x64 Offline Installer (~790 MB) çoğu modern Windows bilgisayar için uygundur.',
      },
      step3: {
        title: 'İndirilen dosyayı bulun',
        desc: 'İndirme tamamlandığında dosya genellikle İndirilenler klasörünüzde görünür. CitrixWorkspaceApp.exe veya benzeri bir .exe dosyası olacaktır.',
        hint: 'Dosyaya çift tıklayarak kurulumu başlatın.',
        tip: 'İndirme yarıda kaldıysa dosyayı silip tekrar indirin.',
      },
      step4: {
        title: 'Kurulum sihirbazını takip edin',
        desc: 'Kurulum penceresi açıldığında ekrandaki yönergeleri izleyin.',
        next: 'İleri / Next',
        accept: 'Lisansı kabul et / Accept',
        install: 'Kur / Install',
        tip: 'Varsayılan ayarları değiştirmeden devam edebilirsiniz.',
      },
      step5: {
        title: 'Kurulumun tamamlanmasını bekleyin',
        desc: 'İlerleme çubuğu %100\'e ulaşana kadar bekleyin. "Kurulum tamamlandı" veya "Finish" mesajını gördüğünüzde kurulum bitmiştir.',
        installerTitle: 'Citrix Workspace kuruluyor…',
        tip: 'Kurulum sırasında bilgisayarı kapatmayın veya uyku moduna almayın.',
      },
      step6: {
        title: 'Bilgisayarı yeniden başlatın',
        desc: 'Kurulum bittikten sonra bilgisayarınızı bir kez yeniden başlatın. Bu adım Citrix bileşenlerinin düzgün çalışması için gereklidir.',
        restartTitle: 'Bir kez yeniden başlatın',
        restartDesc: 'Yeniden başlatma sonrası Citrix Workspace kullanıma hazır olacaktır.',
        tip: 'Açık dosyalarınızı kaydedip yeniden başlatmayı onaylayın.',
      },
      step7: {
        title: 'Citrix kullanıma hazır',
        desc: 'Yeniden başlatma tamamlandıktan sonra Başlat menüsünden Citrix Workspace\'i açabilir ve kullanıcı adı ile şifrenizle giriş yapabilirsiniz.',
        readyTitle: 'Kurulum tamamlandı!',
        readyDesc: 'Citrix Workspace artık kullanıma hazır. Giriş için e-posta değil, kullanıcı adınızı kullanın.',
        tip: 'İlk açılışta mikrofon izni istenirse "Otomatik bağlan" seçeneğini işaretleyin.',
      },
    },
    footer: {
  ...
  de: {
    ...
    citrixSetup: {
      ...
      alertText: 'Bei schwacher Internetverbindung oder Firmennetz-Beschränkungen laden Sie die „Offline Installer"-Version herunter (~790 MB, alle Komponenten in einer Datei).',
      ...
      eulaDecline: 'Nein',
      tipLabel: 'Tipp',
      footerNote: 'Nach der Installation können Sie Citrix Workspace mit Benutzername und Passwort öffnen. Bei Problemen wenden Sie sich an den IT-Support.',
      step1: {
        title: 'Zur Citrix-Downloadseite gehen',
        desc: 'Klicken Sie auf die Schaltfläche unten, um die offizielle Citrix Workspace Downloadseite zu öffnen.',
        visualTitle: 'Citrix Downloadseite',
        visual1: 'Auf der Seite sehen Sie die verfügbaren Windows-Versionen.',
        tip: 'Bei Firmenkonto ggf. die von der IT freigegebene Version verwenden.',
      },
      step2: {
        title: 'Offline-Installer herunterladen',
        desc: 'Suchen Sie die Zeile „Citrix Workspace app … for Windows — Offline installer". Akzeptieren Sie die Lizenz und klicken Sie auf Download.',
        visualTitle: 'Die richtige Datei wählen',
        tip: 'x64 Offline Installer (~790 MB) ist für die meisten modernen Windows-PCs geeignet.',
      },
      step3: {
        title: 'Heruntergeladene Datei finden',
        desc: 'Nach dem Download liegt die Datei meist im Ordner „Downloads". Es handelt sich um eine .exe-Datei (z. B. CitrixWorkspaceApp.exe).',
        hint: 'Doppelklicken Sie auf die Datei, um die Installation zu starten.',
        tip: 'Bei abgebrochenem Download Datei löschen und erneut herunterladen.',
      },
      step4: {
        title: 'Installationsassistent folgen',
        desc: 'Folgen Sie den Anweisungen im Installationsfenster.',
        next: 'Weiter / Next',
        accept: 'Lizenz akzeptieren / Accept',
        install: 'Installieren / Install',
        tip: 'Standard-Einstellungen können beibehalten werden.',
      },
      step5: {
        title: 'Installation abwarten',
        desc: 'Warten Sie, bis der Fortschrittsbalken 100 % erreicht. Bei „Installation abgeschlossen" oder „Finish" ist die Installation fertig.',
        installerTitle: 'Citrix Workspace wird installiert…',
        tip: 'PC während der Installation nicht ausschalten oder in den Ruhezustand versetzen.',
      },
      step6: {
        title: 'Computer neu starten',
        desc: 'Starten Sie den Computer nach der Installation einmal neu. Dies ist für den ordnungsgemäßen Betrieb von Citrix erforderlich.',
        restartTitle: 'Einmal neu starten',
        restartDesc: 'Nach dem Neustart ist Citrix Workspace einsatzbereit.',
        tip: 'Offene Dateien speichern und Neustart bestätigen.',
      },
      step7: {
        title: 'Citrix ist bereit',
        desc: 'Nach dem Neustart öffnen Sie Citrix Workspace über das Startmenü und melden sich mit Benutzername und Passwort an.',
        readyTitle: 'Installation abgeschlossen!',
        readyDesc: 'Citrix Workspace ist einsatzbereit. Verwenden Sie Ihren Benutzernamen — nicht Ihre E-Mail.',
        tip: 'Bei Mikrofonabfrage beim ersten Start „Automatisch verbinden" wählen.',
      },
    },
    footer: {
  ...
  en: {
    ...
    citrixSetup: {
      ...
      alertText: 'If your internet is slow or restricted, download the "Offline Installer" version (~790 MB, all components in one file).',
      ...
      eulaDecline: 'No',
      tipLabel: 'Tip',
      footerNote: 'After installation, open Citrix Workspace and sign in with your username and password. Contact IT support if you have issues.',
      step1: {
        title: 'Go to the Citrix download page',
        desc: 'Click the button below to open the official Citrix Workspace download page in your browser.',
        visualTitle: 'Citrix Download Page',
        visual1: 'You will see available Windows versions on the page.',
        tip: 'If you have a company account, confirm the approved version with IT.',
      },
      step2: {
        title: 'Download the Offline Installer',
        desc: 'Find the row "Citrix Workspace app … for Windows — Offline installer". Accept the license, then click Download.',
        visualTitle: 'Select the correct file',
        tip: 'x64 Offline Installer (~790 MB) suits most modern Windows PCs.',
      },
      step3: {
        title: 'Locate the downloaded file',
        desc: 'When the download completes, the file is usually in your Downloads folder as a .exe (e.g. CitrixWorkspaceApp.exe).',
        hint: 'Double-click the file to start installation.',
        tip: 'If the download was interrupted, delete the file and download again.',
      },
      step4: {
        title: 'Follow the installation wizard',
        desc: 'When the installer opens, follow the on-screen instructions.',
        next: 'Next',
        accept: 'Accept license / Accept',
        install: 'Install',
        tip: 'You can keep the default settings.',
      },
      step5: {
        title: 'Wait for installation to finish',
        desc: 'Wait until the progress bar reaches 100%. When you see "Installation complete" or "Finish", setup is done.',
        installerTitle: 'Installing Citrix Workspace…',
        tip: 'Do not shut down or sleep the PC during installation.',
      },
      step6: {
        title: 'Restart your computer',
        desc: 'After installation, restart your computer once. This is required for Citrix components to work properly.',
        restartTitle: 'Restart once',
        restartDesc: 'After restart, Citrix Workspace will be ready to use.',
        tip: 'Save open files and confirm the restart.',
      },
      step7: {
        title: 'Citrix is ready',
        desc: 'After restart, open Citrix Workspace from the Start menu and sign in with your username and password.',
        readyTitle: 'Setup complete!',
        readyDesc: 'Citrix Workspace is ready. Use your username to sign in — not your email address.',
        tip: 'If prompted for microphone access on first launch, choose "Connect automatically".',
      },
    },
    footer: {
