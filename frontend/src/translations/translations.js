export const translations = {
  "tr": {
    ...
    "systemCheck": {
      ...
      "formDesc": "Tarayıcı bazı bilgileri otomatik okur; CPU, disk ve GPU için Sistem Bilgisi’ne bakarak seçim yapın.",
  ...
  "de": {
    ...
    "systemCheck": {
      ...
      "formDesc": "Der Browser liest einige Werte automatisch; für CPU, Disk und GPU wählen Sie anhand der Systeminformationen.",
  ...
  "en": {
    ...
    "systemCheck": {
      ...
      "formDesc": "The browser detects some values automatically; for CPU, disk and GPU, choose based on System Information.",
  ...
  "fr": {
    ...
    "systemCheck": {
      ...
      "formDesc": "Le navigateur lit certaines valeurs automatiquement ; pour le CPU, le disque et le GPU, choisissez d'après les informations système.",
  ...
  "ka": {
    ...
    "systemCheck": {
      ...
      "formDesc": "ბრაუზერი ზოგიერთ მნიშვნელობას ავტომატურად კითხულობს; CPU, დისკი და GPU — სისტემის ინფორმაციით აირჩიეთ.",
