export const translations = {
  "tr": {
    ...
    "headsetTest": {
      ...
      "speakerDesc": "Sol, sağ ve stereo kanalları ayrı ayrı test edin. Sesi yalnızca ilgili kulaktan duymalısınız.",
      "playLeft": "Sol Kanal",
      "playRight": "Sağ Kanal",
      "playStereo": "Stereo",
  ...
  "de": {
    ...
    "headsetTest": {
      ...
      "speakerDesc": "Testen Sie linken, rechten und Stereo-Kanal getrennt. Der Ton sollte nur im jeweiligen Ohr hörbar sein.",
  ...
  "en": {
    ...
    "headsetTest": {
      ...
      "speakerDesc": "Test left, right, and stereo channels separately. Sound should be heard only in the matching ear.",
  ...
  "fr": {
    ...
    "headsetTest": {
      ...
      "speakerDesc": "Testez les canaux gauche, droit et stéréo séparément. Le son ne doit être audible que dans l'oreille correspondante.",
  ...
  "ka": {
    ...
    "headsetTest": {
      ...
      "speakerDesc": "შეამოწმეთ მარცხენა, მარჯვენა და სტერეო არხები ცალ-ცალკე. ხმა უნდა ისმოდეს მხოლოდ შესაბამის ყურში.",
