export const translations = {
  "tr": {
    ...
    "headsetTest": {
      ...
      "speakerDesc": "Testi başlatın; ses otomatik olarak sol, sağ ve stereo kanallarında döner. İsterseniz alttan tek kanalı seçebilirsiniz.",
      "startSpeakerTest": "Ses Testini Başlat",
      "nowPlayingLeft": "Şu an soldan çalıyor",
      "nowPlayingRight": "Şu an sağdan çalıyor",
      "nowPlayingStereo": "Şu an her iki kulaktan çalıyor",
      "autoCycleHint": "Sol → sağ → stereo sırasıyla otomatik devam ediyor",
      "manualTest": "Manuel test",
      "manualTestHint": "Belirli bir kanalı tekrar dinlemek için:",
      "playLeft": "Sol Kanal",
      "playRight": "Sağ Kanal",
      "playStereo": "Stereo",
      "playingLeft": "Sol çalıyor…",
      "playingRight": "Sağ çalıyor…",
      "playingStereo": "Stereo çalıyor…",
      "playSound": "Ses Çal",
      "stopSound": "Durdur",
    ...
    "admin": {
      ...
      "carousel": {
        ...
        "orderDesc": "Yukarı/aşağı oklarıyla sırayı değiştirin. Kalem ile düzenleyin, çöp kutusu ile listeden kaldırın.",
        "builtIn": "Hazır slayt",
        "custom": "Özel slayt",
        "edited": "Düzenlendi",
        "edit": "Düzenle",
        "delete": "Sil",
        "editTitle": "Slaytı düzenle",
        "removeBuiltInConfirm": "Bu hazır slaytı ana sayfadan kaldırmak istediğinize emin misiniz? Özel düzenlemeler de silinir.",
        "moveUp": "Yukarı taşı",
        "moveDown": "Aşağı taşı",
  ...
  "de": {
    ...
    "headsetTest": {
      ...
      "speakerDesc": "Starten Sie den Test — der Ton wechselt automatisch zwischen links, rechts und Stereo. Unten können Sie einen Kanal manuell wählen.",
      "startSpeakerTest": "Audiotest starten",
      "nowPlayingLeft": "Wird links abgespielt",
      "nowPlayingRight": "Wird rechts abgespielt",
      "nowPlayingStereo": "Wird auf beiden Ohren abgespielt",
      "autoCycleHint": "Wechselt automatisch: links → rechts → Stereo",
      "manualTest": "Manueller Test",
      "manualTestHint": "Einen Kanal erneut anhören:",
      "playLeft": "Linker Kanal",
      "playRight": "Rechter Kanal",
      "playStereo": "Stereo",
      "playingLeft": "Links wird abgespielt…",
      "playingRight": "Rechts wird abgespielt…",
      "playingStereo": "Stereo wird abgespielt…",
    ...
    "admin": {
      ...
      "carousel": {
        ...
        "orderDesc": "Mit den Pfeilen die Reihenfolge ändern. Mit Stift bearbeiten, mit Papierkorb entfernen.",
        "builtIn": "Standard-Slide",
        "custom": "Eigener Slide",
        "edited": "Bearbeitet",
        "edit": "Bearbeiten",
        "delete": "Löschen",
        "editTitle": "Slide bearbeiten",
        "removeBuiltInConfirm": "Diesen Standard-Slide von der Startseite entfernen? Eigene Änderungen werden gelöscht.",
        "moveUp": "Nach oben",
        "moveDown": "Nach unten",
  ...
  "en": {
    ...
    "headsetTest": {
      ...
      "speakerDesc": "Start the test — sound automatically cycles through left, right, and stereo. Use the buttons below to listen to one channel only.",
      "startSpeakerTest": "Start Audio Test",
      "nowPlayingLeft": "Now playing from the left",
      "nowPlayingRight": "Now playing from the right",
      "nowPlayingStereo": "Now playing from both ears",
      "autoCycleHint": "Automatically cycling: left → right → stereo",
      "manualTest": "Manual test",
      "manualTestHint": "To listen to a specific channel again:",
      "playLeft": "Left Channel",
      "playRight": "Right Channel",
      "playStereo": "Stereo",
      "playingLeft": "Playing left…",
      "playingRight": "Playing right…",
      "playingStereo": "Playing stereo…",
    ...
    "admin": {
      ...
      "carousel": {
        ...
        "orderDesc": "Change order with arrows. Edit with pencil, remove with trash.",
        ...
        "removeBuiltInConfirm": "Remove this built-in slide from the home page? Custom edits will be deleted too.",
        "moveUp": "Move up",
        "moveDown": "Move down",
  ...
  "fr": {
    ...
    "headsetTest": {
      ...
      "speakerDesc": "Lancez le test — le son alterne automatiquement entre gauche, droit et stéréo. Utilisez les boutons ci-dessous pour un canal précis.",
      "startSpeakerTest": "Démarrer le test audio",
      "nowPlayingLeft": "Lecture à gauche en cours",
      "nowPlayingRight": "Lecture à droite en cours",
      "nowPlayingStereo": "Lecture des deux oreilles en cours",
      "autoCycleHint": "Alternance automatique : gauche → droit → stéréo",
      "manualTest": "Test manuel",
      "manualTestHint": "Pour réécouter un canal précis :",
      "playLeft": "Canal gauche",
      "playRight": "Canal droit",
      "playStereo": "Stéréo",
      "playingLeft": "Lecture à gauche…",
      "playingRight": "Lecture à droite…",
      "playingStereo": "Lecture stéréo…",
    ...
    "admin": {
      ...
      "carousel": {
        ...
        "orderDesc": "Modifiez l'ordre avec les flèches. Crayon pour modifier, corbeille pour supprimer.",
        ...
        "removeBuiltInConfirm": "Retirer cette diapositive intégrée de la page d'accueil ? Les modifications seront supprimées.",
  ...
  "ka": {
    ...
    "headsetTest": {
      ...
      "speakerDesc": "დაიწყეთ ტესტი — ხმა ავტომატურად იცვლება მარცხენა, მარჯვენა და სტერეო არხებს შორის. ქვემოთ შეგიძლიათ ერთი არხის არჩევა.",
      "startSpeakerTest": "აუდიო ტესტის დაწყება",
      "nowPlayingLeft": "ახლა მარცხენიდან იკვრება",
      "nowPlayingRight": "ახლა მარჯვნიდან იკვრება",
      "nowPlayingStereo": "ახლა ორივე ყურიდან იკვრება",
      "autoCycleHint": "ავტომატური ციკლი: მარცხენა → მარჯვენა → სტერეო",
      "manualTest": "ხელით ტესტი",
      "manualTestHint": "კონკრეტული არხის თავიდან მოსმენისთვის:",
      "playLeft": "მარცხენა არხი",
      "playRight": "მარჯვენა არხი",
      "playStereo": "სტერეო",
      "playingLeft": "მარცხენა იკვრება…",
      "playingRight": "მარჯვენა იკვრება…",
      "playingStereo": "სტერეო იკვრება…",
    ...
    "admin": {
      ...
      "carousel": {
        ...
        "orderDesc": "გამოიყენეთ ისრები თანმიმდევრობის შესაცვლელად. ფანქრით რედაქტირება, ნაგებით წაშლა.",
        "builtIn": "ჩამონტაჟებული სლაიდი",
        "custom": "მორგებული სლაიდი",
        "edited": "რედაქტირებული",
        "edit": "რედაქტირება",
        "delete": "წაშლა",
        "editTitle": "სლაიდის რედაქტირება",
        "removeBuiltInConfirm": "ამ ჩამონტაჟებული სლაიდის მთავარ გვერდიდან წაშლა? ცვლილებებიც წაიშლება.",
